        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
             <form class="form-horizontal" method="post" action="<?php echo base_url()?>pekerjaan/simpanTambah">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        <label for="nama" class="col-sm-4 control-label" >Judul Pekerjaan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan pekerjaan">
                        </div>
                      </div>     
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                           <input type="number" class="form-control" id="tarif" name="tarif" placeholder="Masukkan pekerjaan"> 
                        </div>
                      </div>      
                      <div class="form-group">
                        <label for="waktu" class="col-sm-4 control-label" >Waktu Pengerjaan (hari)</label>
                        <div class="col-sm-8">
                           <input type="number" class="form-control" id="waktu" name="waktu" placeholder="Masukkan pekerjaan"> 
                        </div>
                      </div>                 
                  </div>                  
                </div>               
